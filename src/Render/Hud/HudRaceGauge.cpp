...
void HudRaceOverlay::drawNitroBar(const Car &car, const Rectangle &panel, float panelW,
    float panelH)
{
    ...
    HudGfx::drawText("NITRO", static_cast<int>(panel.x + 20.0f),
        static_cast<int>(barY), 13, HudGfx::fade(ORANGE, 0.95f));
